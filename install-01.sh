...
# Utils
install_packages waybar ranger btop obsidian libreoffice-fresh signal-desktop cliphist pam_yubico pam-u2f atool unzip zip sxiv p7zip net-tools openvpn proton-vpn-gtk-app jq obs xdg-desktop-portal-hyprland gimp blender inkscape steam timeshift
